...
cache_file = Path(fr'C:\Users\Alkor\PycharmProjects\beget_rss\{ticker_lc}_{rss_provider}\{ticker_lc}_embeddings_{rss_provider}_ollama.pkl')
...
# Итоговый XLSX файл
result_file = Path(
    fr'C:\Users\Alkor\PycharmProjects\beget_rss\{ticker_lc}_{rss_provider}\{ticker_lc}_backtest_results_{rss_provider}_ollama.xlsx')

# Настройка логирования: вывод в консоль и в файл, файл перезаписывается
log_file = Path(
    fr'C:\Users\Alkor\gd\predict_ai\{ticker_lc}_{rss_provider}_ollama\log\{ticker_lc}_backtesting_{rss_provider}_ollama.txt')
