...
# log_file = Path(fr'{ticker_lc}_predict_next_session_{rss_provider}_ollama.txt')
log_file = Path(
    fr'C:\Users\Alkor\gd\predict_ai\{ticker_lc}_{rss_provider}_ollama\log\{ticker_lc}_predict_next_session_{rss_provider}_ollama.txt')
