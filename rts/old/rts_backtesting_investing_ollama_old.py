...
cache_file = Path(
    ...
    fr'\{ticker_lc}_embeddings_investing_ollama.pkl')
...
result_file = Path(
    fr'C:\Users\Alkor\PycharmProjects\beget_rss\{ticker_lc}'
    fr'\{ticker_lc}_backtest_results_investing_ollama.xlsx')

# Настройка логирования: вывод в консоль и в файл, файл перезаписывается
log_file = Path(
    fr'C:\Users\Alkor\gd\predict_ai\{ticker_lc}_investing_ollama\log'
    fr'\{ticker_lc}_backtesting_investing_ollama.txt')
