...
def load_markdown_files(directory):
    ...
    for file_path in files:
        ...
        # md5_hash = hashlib.md5(content.encode('utf-8')).hexdigest()  # Todo для старого кэша комментируем
        ...
        if content.startswith('---'):
            ...
            if len(parts) >= 3:
                ...
                md5_hash = hashlib.md5(text_content.encode('utf-8')).hexdigest()  # Todo для старого кэша разкомментируем
