...
SOURCE_DIR = r"C:\Users\Alkor\gd\data_quote_db"   # Папка, где хранятся исходные базы SQLite
SOURCE_MASK = "minutes_RTS_*.sqlite"               # Маска поиска исходных файлов
LOOKBACK_DAYS = 10                                 # Количество торговых дней для расчёта Percentile
TARGET_DB = f"minutes_RTS_processed_p{LOOKBACK_DAYS}.sqlite"  # Имя выходной базы
LOG_FILE = "process_quotes.log"                    # Имя файла для логов
