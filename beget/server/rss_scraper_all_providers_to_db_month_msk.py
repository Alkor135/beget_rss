...
LOG_FILE = Path(LOG_DIR / "rss_scraper_all_providers_to_db_month_msk.log")  # log file path

# --- Настройка логирования (MSK + сброс старых обработчиков) ---
os.makedirs(BASE_DIR, exist_ok=True)
os.makedirs(LOG_DIR, exist_ok=True)

# Принудительно конвертируем timestamp в московское время для всех форматтеров
...
# Сбрасываем ВСЕ старые обработчики (важно!)
