"""
Скрипт для скачивания файлов с сервера MakeCloud по SSH с использованием библиотеки Paramiko.
...
log_dir = Path('C:\\Users\\Alkor\\gd\\data_makecloud_rss\\log')
log_dir.mkdir(parents=True, exist_ok=True)
# Определение файла логов
log_file = Path('C:\\Users\\Alkor\\gd\\data_makecloud_rss\\log\\download_log.log')
...
def download_files():
    ...
    try:
        ...
        local_log_dir = Path('C:\\Users\\Alkor\\gd\\data_makecloud_rss\\log')  # Для логов
        ...
        remote_files = [
            ('/home/ubuntu/rss_scraper/db_data/rss_news_investing.db', local_db_dir),
            ('/home/ubuntu/rss_scraper/db_data/rss_news_investing_2025_06.db', local_db_dir),
            ('/home/ubuntu/rss_scraper/db_data/rss_news_investing_2025_07.db', local_db_dir),
            ('/home/ubuntu/rss_scraper/db_data/rss_news_investing_2025_08.db', local_db_dir),
            # ('/home/ubuntu/rss_scraper/db_data/RTS_day_rss_2025.db', local_db_dir),
            # ('/home/ubuntu/rss_scraper/db_data/MIX_day_rss_2025.db', local_db_dir),
            ('/home/ubuntu/rss_scraper/log/rss_scraper.log', local_log_dir),
            ('/home/ubuntu/rss_scraper/log/rss_scraper_month.log', local_log_dir)
            # ('/home/ubuntu/rss_scraper/log/rts_quote_download_to_db.log', local_log_dir),
            # ('/home/ubuntu/rss_scraper/log/mix_quote_download_to_db.log', local_log_dir)
        ]
