...
Этот проект предназначен для визуализации и анализа данных о доходности торговых операций из файла `buhinvest_futures_RTS_MIX_без_пароля.xlsx` в рублях (RUR).
